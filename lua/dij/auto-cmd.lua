...
autocmd({ "BufEnter" }, {
  desc = "quit with <Esc> in nofile buffers",
  group = vim.api.nvim_create_augroup("quitnofile", { clear = true }),
  callback = function()
...
autocmd({ "BufwritePost" }, {
  group = vim.api.nvim_create_augroup("save view on leave", { clear = true }),
  callback = function()
...
autocmd({ "BufRead" }, {
  group = vim.api.nvim_create_augroup("restore-view-on-enter", { clear = true }),
  callback = function()
